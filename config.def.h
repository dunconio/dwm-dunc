...
static unsigned int config_warnings = 1;		// Show warnings relating to json config file;
...
static char *colours[][3] = {
	...
	#if PATCH_FLAG_HIDDEN
	[SchemeTagBarHide]={ NULL, NULL, NULL },
	#endif // PATCH_FLAG_HIDDEN
...
#if PATCH_STATUSCMD_COLOURS && PATCH_STATUSCMD_COLOURS_DECOLOURIZE
static Bool status_decolourize_inactive = True;
#endif // PATCH_STATUSCMD_COLOURS && PATCH_STATUSCMD_COLOURS_DECOLOURIZE
#endif // PATCH_STATUSCMD
...
// toggles
	...
	{ ShiftMask,                    XF86AudioPlay,    spawn,   SHCMD("bash $XDG_RUNTIME_DIR/dwm/pactl-mute-app.sh firefox freetube kodi thorium vlc"), DESCRIPTION_MUTE_MEDIA_APPS },
	{ ShiftMask|ControlMask,        XF86AudioPlay,    spawn,   SHCMD("bash $XDG_RUNTIME_DIR/dwm/pactl-mute-media-except-active.sh firefox freetube kodi thorium vlc"), DESCRIPTION_MUTE_MEDIA_APPS_EXCEPT_ACTIVE },
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask, XK_k,    spawn,   SHCMD("bash -c $HOME/Debian-setup/slock/slock"), DESCRIPTION_LOCK_SCREEN },
	...
	{ ShiftMask|ControlMask,XF86AudioRaiseVolume,spawn,        SHCMD ("pamixer --allow-boost --set-limit 150 -i 5 >/dev/null 2>&1; pkill -RTMIN+8 dwmblocks"), DESCRIPTION_VOLUME_UP_BOOST},
	...
	{ Mod4Mask|Mod1Mask,            XK_Tab,    altTabStart,	   {.ui = (ALTTAB_SELMON_MASK | ALTTAB_ALL_TAGS | ALTTAB_SORTED) }, DESCRIPTION_ALTTAB_TAGS },
	{ Mod4Mask|Mod1Mask|ShiftMask,  XK_Tab,    altTabStart,	   {.ui = (ALTTAB_SELMON_MASK | ALTTAB_ALL_TAGS | ALTTAB_REVERSE | ALTTAB_SORTED) }, DESCRIPTION_ALTTAB_TAGS_REVERSE },
	{ Mod1Mask|ControlMask,         XK_Tab,    altTabStart,	   {.ui = (ALTTAB_SELMON_MASK | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_SORTED_BY_MONITOR) }, DESCRIPTION_ALTTAB_TAGS_MONS },
	{ Mod1Mask|ControlMask|ShiftMask,XK_Tab,   altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_REVERSE | ALTTAB_SORTED_BY_MONITOR) }, DESCRIPTION_ALTTAB_TAGS_MONS_REVERSE },
	...
	{ Mod4Mask|Mod1Mask,           	XK_grave,  altTabStart,	   {.ui = (ALTTAB_SELMON_MASK | ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_SORTED) }, DESCRIPTION_ALTTAB_CLASS_TAGS },
	{ Mod4Mask|Mod1Mask|ShiftMask,  XK_grave,  altTabStart,	   {.ui = (ALTTAB_SELMON_MASK | ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_REVERSE | ALTTAB_SORTED) }, DESCRIPTION_ALTTAB_CLASS_TAGS_REVERSE },
	{ Mod1Mask|ControlMask,         XK_grave,  altTabStart,	   {.ui = (ALTTAB_SELMON_MASK | ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_SORTED_BY_MONITOR) }, DESCRIPTION_ALTTAB_CLASS_TAGS_MONS },
	{ Mod1Mask|ControlMask|ShiftMask,XK_grave, altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_REVERSE | ALTTAB_SORTED_BY_MONITOR) }, DESCRIPTION_ALTTAB_CLASS_TAGS_MONS_REVERSE },
	{ Mod4Mask|ControlMask|Mod1Mask,XK_Tab,    altTabStart,	   {.ui = (1 | ALTTAB_ALL_TAGS | ALTTAB_SORTED) }, DESCRIPTION_ALTTAB_TAGS_1 },
#endif // PATCH_ALTTAB
#if PATCH_TORCH
...
static const Button buttons[] = {
...
#if PATCH_ALTTAB
	{ ClkWinTitle,          0,              Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU) } },
	{ ClkWinTitle,          Mod4Mask,       Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle,          Mod1Mask,       Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS ) } },
	{ ClkWinTitle, Mod4Mask|Mod1Mask,       Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle,          ControlMask,    Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_ALL_MONITORS ) } },
	{ ClkWinTitle, Mod4Mask|ControlMask,    Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_ALL_MONITORS | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle, Mod1Mask|ControlMask,    Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS ) } },
	{ ClkWinTitle, Mod4Mask|Mod1Mask|ControlMask, Button1,  altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle,          0,              Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS ) } },
	{ ClkWinTitle,          Mod4Mask,       Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle,          Mod1Mask,       Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS ) } },
	{ ClkWinTitle, Mod4Mask|Mod1Mask,       Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle,          ControlMask,    Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS ) } },
	{ ClkWinTitle, Mod4Mask|ControlMask,    Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_SORTED_BY_MONITOR ) } },
	...
	{ ClkWinTitle, Mod4Mask|Mod1Mask|ControlMask, Button3,  altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_SORTED_BY_MONITOR ) } },
#if PATCH_FLAG_HIDDEN
	{ ClkWinTitle,          ShiftMask,      Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod4Mask|ShiftMask,      Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle, Mod1Mask|ShiftMask,      Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod4Mask|Mod1Mask|ShiftMask, Button1,    altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle, ShiftMask|ControlMask,   Button1,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod4Mask|ShiftMask|ControlMask, Button1, altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle, Mod1Mask|ControlMask|ShiftMask,Button1,  altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod4Mask|Mod1Mask|ControlMask|ShiftMask,Button1,altTabStart,{.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_OFFSET_MENU | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	{ ClkWinTitle,          ShiftMask,      Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod4Mask|ShiftMask,      Button3,        altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	...
	{ ClkWinTitle, Mod4Mask|Mod1Mask|ShiftMask, Button3,    altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	...
	{ ClkWinTitle, Mod4Mask|ShiftMask|ControlMask, Button3, altTabStart,    {.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
	...
	{ ClkWinTitle, Mod4Mask|Mod1Mask|ControlMask|ShiftMask,Button3,altTabStart,{.ui = (ALTTAB_SELMON_MASK | ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN | ALTTAB_SORTED_BY_MONITOR ) } },
#endif // PATCH_FLAG_HIDDEN
#endif // PATCH_ALTTAB
