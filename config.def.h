...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_c,      spawn,          SHCMD("chromium >/dev/null 2>&1")},
	{ MODKEY|ShiftMask|ControlMask, XK_c,      spawn,          SHCMD("chromium --incognito >/dev/null 2>&1")},
	...
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask, XK_m,    spawn,   SHCMD("bash $XDG_RUNTIME_DIR/dwm/pactl-mute-output.sh")},
...
#endif // PATCH_FLAG_HIDDEN
#if PATCH_ALTTAB
	{ Mod1Mask,             		XK_Tab,    altTabStart,	   {.ui = (ALTTAB_NORMAL) } },
	{ Mod1Mask|ShiftMask,      		XK_Tab,    altTabStart,	   {.ui = (ALTTAB_NORMAL | ALTTAB_REVERSE) } },
	{ MODKEY|Mod1Mask,             	XK_Tab,    altTabStart,	   {.ui = (ALTTAB_ALL_TAGS) } },
	{ MODKEY|Mod1Mask|ShiftMask,    XK_Tab,    altTabStart,	   {.ui = (ALTTAB_ALL_TAGS | ALTTAB_REVERSE) } },
	{ Mod1Mask|ControlMask,         XK_Tab,    altTabStart,	   {.ui = (ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS) } },
	{ Mod1Mask|ControlMask|ShiftMask,XK_Tab,   altTabStart,    {.ui = (ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_REVERSE) } },
	{ Mod1Mask,                     XK_grave,  altTabStart,	   {.ui = (ALTTAB_SAME_CLASS) } },
	{ Mod1Mask|ShiftMask,      	    XK_grave,  altTabStart,	   {.ui = (ALTTAB_SAME_CLASS | ALTTAB_REVERSE) } },
	{ MODKEY|Mod1Mask,             	XK_grave,  altTabStart,	   {.ui = (ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS) } },
	{ MODKEY|Mod1Mask|ShiftMask,    XK_grave,  altTabStart,	   {.ui = (ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_REVERSE) } },
	{ Mod1Mask|ControlMask,         XK_grave,  altTabStart,	   {.ui = (ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS) } },
	{ Mod1Mask|ControlMask|ShiftMask,XK_grave, altTabStart,    {.ui = (ALTTAB_SAME_CLASS | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_REVERSE) } },
#endif // PATCH_ALTTAB
#if PATCH_TORCH
...
#if PATCH_ALTTAB
	{ ClkWinTitle,          0,              Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE) } },
	{ ClkWinTitle,          Mod1Mask,       Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_SAME_CLASS ) } },
	{ ClkWinTitle,          ControlMask,    Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_MONITORS ) } },
	{ ClkWinTitle, Mod1Mask|ControlMask,    Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS ) } },
	{ ClkWinTitle,          0,              Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS ) } },
	{ ClkWinTitle,          Mod1Mask,       Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS ) } },
	{ ClkWinTitle,          ControlMask,    Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS ) } },
	{ ClkWinTitle, Mod1Mask|ControlMask,    Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS ) } },
#if PATCH_FLAG_HIDDEN
	{ ClkWinTitle,          ShiftMask,      Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_HIDDEN) } },
	{ ClkWinTitle, Mod1Mask|ShiftMask,      Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_SAME_CLASS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, ShiftMask|ControlMask,   Button1,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod1Mask|ControlMask|ShiftMask,Button1,  altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle,          ShiftMask,      Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod1Mask|ShiftMask,      Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, ShiftMask|ControlMask,   Button3,        altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN ) } },
	{ ClkWinTitle, Mod1Mask|ControlMask|ShiftMask,Button3,  altTabStart,    {.ui = (ALTTAB_MOUSE | ALTTAB_ALL_TAGS | ALTTAB_SAME_CLASS | ALTTAB_ALL_MONITORS | ALTTAB_HIDDEN ) } },
#endif // PATCH_FLAG_HIDDEN
#endif // PATCH_ALTTAB
