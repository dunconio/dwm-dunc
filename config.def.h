...
// toggles
	...
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask, XK_slash,spawn,   SHCMD("bash $XDG_RUNTIME_DIR/dwm/pactl-mute-app.sh firefox freetube thorium vlc"), DESCRIPTION_MUTE_MEDIA_APPS },
