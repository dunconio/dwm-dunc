...
#define IPC_EVENT_STRING_CLIENT_FOCUS_CHANGE "client_focus_change_event"
#define IPC_EVENT_STRING_FOCUSED_STATE_CHANGE "focused_state_change_event"
#define IPC_EVENT_STRING_FOCUSED_TITLE_CHANGE "focused_title_change_event"
#define IPC_EVENT_STRING_LAYOUT_CHANGE "layout_change_event"
#define IPC_EVENT_STRING_MONITOR_FOCUS_CHANGE "monitor_focus_change_event"
#define IPC_EVENT_STRING_TAG_CHANGE "tag_change_event"
...
typedef enum IPCMessageType {
	...
	IPC_TYPE_FIND_DWM_CLIENT = 4,
	IPC_TYPE_GET_DWM_CLIENT = 5,
	IPC_TYPE_SUBSCRIBE = 6,
	IPC_TYPE_EVENT = 7,
} IPCMessageType;

typedef enum IPCEvent {
	IPC_EVENT_CLIENT_FOCUS_CHANGE = 1 << 0,
	IPC_EVENT_FOCUSED_STATE_CHANGE = 1 << 1,
	IPC_EVENT_FOCUSED_TITLE_CHANGE = 1 << 2,
	IPC_EVENT_LAYOUT_CHANGE = 1 << 3,
	IPC_EVENT_MONITOR_FOCUS_CHANGE = 1 << 4,
	IPC_EVENT_TAG_CHANGE = 1 << 5,
} IPCEvent;
