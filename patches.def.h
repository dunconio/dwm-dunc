...
// Core functionality
#define PATCH_ACTIVE_CLIENT_CHECKS			1	// Support querying the active client's state while setting rules for (other) clients;
...
#define PATCH_CUSTOM_TAG_ICONS				1	// Enable per-tag a user-specified icon in place of tag number (alt-tag);
