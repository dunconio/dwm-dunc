...
| <ul>`PATCH_STATUSCMD_NONPRINTING`</ul> | Supports using status bar content with non-printing characters denoted by `^Nchars^`, where the width of `chars` will be added to the width of the status section; |
